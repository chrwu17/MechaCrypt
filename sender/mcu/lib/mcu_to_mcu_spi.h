 ...
 * @author Christian Wu
 * @date 2025-12-03
 * @brief Header for MCU-to-MCU SPI key transfer using shared SPI1 bus
 * 
 * Architecture: Sender and Receiver MCUs share SPI1 bus (SCK, MOSI, MISO)
 *               with separate chip select pins for device multiplexing
 * 
 * Protocol:
 * 1. Sender asserts RX_MCU_CS (PA8 LOW)
 * 2. Sender sends header: [msg_length_byte][num_blocks_byte]
 * 3. Sender sends N keys: [16 bytes per key] x N blocks
 * 4. Sender deasserts RX_MCU_CS (PA8 HIGH)
 * 5. Receiver polls CS pin and reads via hardware SPI
 */
...
///////////////////////////////////////////////////////////////////////////////
// Pin Definitions - Shared SPI1 Bus
///////////////////////////////////////////////////////////////////////////////
...
#define FPGA_CS           PA11  // CS for FPGA (encryption) - existing
#define RX_MCU_CS         PA8   // CS for receiver MCU (key transfer) - NEW

// RECEIVER: Separate chip selects  
#define RX_FPGA_CS        PA11  // CS for FPGA (decryption) - existing
#define RX_MCU_CS_IN      PA8   // CS input from sender MCU - NEW
