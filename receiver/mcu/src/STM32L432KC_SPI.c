...
void initSPI(int br, int cpol, int cpha) {
    ...
    // Add software slave management
    SPI1->CR1 |= SPI_CR1_SSM | SPI_CR1_SSI;  // <-- ADD THIS LINE
    
    // Configure CR2 - REMOVE SSOE
    SPI1->CR2 = _VAL2FLD(SPI_CR2_DS, 0b0111) | SPI_CR2_FRXTH;  // <-- REMOVED SSOE
